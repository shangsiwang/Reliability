...
\db{Optimal Discovery Science via Maximizing Discriminability: \\ Applications in Neuroimaging}
}
...
\para{Challenge} Deciding on how to collect and process the data, in the absence of an explicit task
