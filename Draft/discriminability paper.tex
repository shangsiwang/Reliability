...
\db{Optimal Design via Maximizing Discriminability: \\ Applications in Neuroimaging}
}
...
\item Describe how we threshold correlation and what is being predicted
\item explain the result
\end{itemize}
...
\begin{itemize}
	...
	\item Explain what decisions are  4 atlases, nff vs frf, fsl vs ant, scrub vs no scr, gsr vs no gsr. 
...
\begin{itemize}
	...
	\item Explain it offers large improvement when there is no gsr, small when there is gsr.s
\end{itemize}
\begin{figure}[t!]
