%Perform simulation experiment 1
...
for iter=1:rep
    ...
    MU2=[1 1];
    SIGMA=[1 0; 0 2];
    O11=mvnrnd(MU1,SIGMA,n/2); %observations of subject 1
    O12=mvnrnd(MU2,SIGMA,n/2); %observations of subject 2
    O1=[O11 ; O12]; % all observations
